 ...
 * @author FuKuiXiang
 * @version 1.0.0
 * @date 2023/11/28 13:42
 * @Description
 */
public class GarbageCollectorBeanTest {
    ...
    public static void main(String[] args) {
        ...
        GarbageCollectorBeanTest beanTest = new GarbageCollectorBeanTest();
        System.out.println(beanTest.collectGC());
    }
