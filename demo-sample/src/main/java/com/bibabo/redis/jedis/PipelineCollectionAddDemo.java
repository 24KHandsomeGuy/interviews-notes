 ...
 */
@Slf4j
public class PipelineCollectionAddDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RSetAsync<String> rSetAsync = rBatch.getSet(key3);
        for (int i = size * 2;i < size * 3;i ++){
            rSetAsync.addAsync(i + "");
        }
